...
import { resetStatus, updateCategory } from "../../../../store/adminCategorySlice."
...
const EditModal:React.FC<ModalProps> = ({closeEditModal,categoryId ,oldCategoryName})=>{
    console.log(oldCategoryName,categoryId)
    const dispatch = useAppDispatch()
   const [categoryName,setCategoryName] = useState<string>(oldCategoryName)
   ...
   const [loading,setLoading] = useState(false)
    const handleSubmit = async (e:FormEvent<HTMLFormElement>)=>{
        ...
        try {
            ...
            await dispatch(updateCategory({id:categoryId,categoryName}))
        } catch (error) {
            console.log(error)
            setLoading(false)
        }
...
<div id="modal" className="fixed inset-0 z-50 flex items-center justify-center">
  ...
  <div className="relative w-full max-w-md p-6 bg-white dark:bg-gray-800 rounded-lg shadow-xl">
    <div className="flex items-center justify-between mb-4">
      ...
      <button onClick={closeEditModal} id="closeModalButton" className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
    ...
    <div className="space-y-4">
     ...
     <div>
      ...
      <div className="flex justify-end gap-3">
        <button onClick={closeEditModal} id="cancelButton" className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-600">
          Cancel
        </button>
