...
import { addProduct, resetStatusAdmin } from "../../../../store/adminProductSlice"
...
const ProductModal:React.FC<ModalProps> = ({closeModal})=>{
   ...
   const [data,setData] = useState <IProductModal>({
    productName : "", 
    productDescription :"", 
    categoryId : "", 
    productImageUrl : "", 
   ...
   const {status} = useAppSelector((state)=>state.adminProducts)
    ...
    <div className="space-y-4">
     ...
     <div>
      ...
      <div>
        ...
        <input  name="productImageUrl"  onChange={handleChange} type="file" id="website_url" className="w-[220px] mt-1 p-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200 placeholder-gray-400 dark:placeholder-gray-500"  required />
      </div>
      <div>
